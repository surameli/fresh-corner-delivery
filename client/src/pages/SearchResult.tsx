        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
         ...
         {loading ?(
          ...
          <div className="text-center py-20">
              <Search className="size-16 text-app-border mx-autp mb-4"/>
              <h2 className="text-xl font-semibold text-app-green mb-2">No results found</h2>
              <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto"> We couldn.t find any products matching "{query}# . Try  different search term</p>
