      ...
      <div className="bg-linear-to-r from-app-orange to-app-orange-dark text-white py-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 text-center">
          ...
          <p className=" text-white/80 max-w-md mx-auto">Limited time offers! Grab the best deals on fresh groceries before they run out!</p>
           ...
           <div className="max-w-7x1 mx-auto px-4 sm:px-6 1g:px-8 py-8">
            {loading ? ( <Loading />) : (
                products.length === 0 ? (
             <div className="text-center py-16">
            <Zap className="size-16 text-app-border mx-auto mb-4" />
            <h2 className="text-lg font-semibold text-app-green mb-2">No
              deals right now</h2>
            <p className="text-sm text-app-text-light">Check back soon
              for amazing offers!</p>
           </div>
           ) : (
